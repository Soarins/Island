...
screen main_menu:
    ...
    # добавить фон в соответствии с текущим временем суток
    add "%s.jpg" % (gett())   
    ...
    frame:
        ...
        textbutton _("Новая игра") action Jump("restart")
        textbutton _("Продолжить") action FileLoad(1, confirm=False, page="auto", newest=True)
        textbutton _("Загрузить игру") action ShowMenu("load")
        textbutton _("Настройки") action ShowMenu("preferences")
        textbutton _("Справка") action ShowMenu("help")
        textbutton _("Выход") action Quit(layout.QUIT)
...
init -2 python:
    ...
    # свой бегунок громкости и не только
    
    style.pref_slider.left_bar = "image_install/3.png" # весь слайдер окрашенный в цвет, что слева от бегунка
    style.pref_slider.right_bar = "image_install/3.png" # весь слайдер окрашенный в цвет, что справа от бегунка
    style.pref_slider.thumb = "image_install/one.png" # рисунок бегунка
    style.pref_slider.thumb_offset = 1 # половина ширины бегунка
    style.pref_slider.thumb_shadow = None
    style.pref_slider.xmaximum = 375 # ширина слайдера (ширина картинок bar_left.png и bar_right.png)
    style.pref_slider.ymaximum = 35 # высота слайдер
